...
library RedemptionQueue {
    ...
    function createRedemptionTicket(State storage _state, address _agentVault, uint64 _valueAMG)
        internal
        returns (uint64)
    {
    ...
    function deleteRedemptionTicket(State storage _state, uint64 _ticketId) internal {
